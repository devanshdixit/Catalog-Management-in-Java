...
public class SellActivity extends AppCompatActivity {
    ...
    private EditText sellamount, deposit, carpertarea, owneragentname, propertyaddress, mobileno;
    ...
    public void saveNote() {
        ...
        String Property_Type = "Sell", referencefrom, Available, referenceType, roomType, tenantType;
        if (Family == null) {
        ...
        Rentamount = sellamount.getText().toString();
        ...
        db.collection("Properties")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        Toast.makeText(SellActivity.this, "Property Added", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                })
